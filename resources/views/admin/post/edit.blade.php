...
<form id="form" action="{{ route('admin.post.update', $post->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('patch')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-12">
                                <input type="text" name="title" placeholder="Judul Post" value="{{ $post->title }}" class="form-control mb-2">
                                <div class="dropdown show float-left">
                                    <button type="button" id="btn-category" class="btn has-dropdown" data-toggle="dropdown" aria-expanded="true">
                                        <i class="fa fa-quote-right mr-2"></i><span id="label-category">{{ isset($post->category->category) ? $post->category->category : 'Pilih Kategori' }}</span><i class="fa fa-chevron-down pl-2"></i>
                                    </button>
                                    <input type="hidden" name="category_id" id="category-id" value="{{ $post->category_id }}" required>
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-12">
                                <input type="text" name="tag" placeholder="Tag" value="{{ $post->tag }}" class="inputtags">
                            </div>
                        </div>
                    </div>
                </div>
