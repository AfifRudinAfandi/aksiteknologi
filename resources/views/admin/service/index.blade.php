...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active">Manajemen Service</div>
    </div>
</div>
@endsection
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-header-action">
                <button class="btn btn-primary" data-toggle="modal" data-target="#add-service-modal"><i class="fas fa-plus mr-2"></i>Tambah</button>
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-md" id="services-table">
                    <thead>
                        <tr>
                            <th>
...
@section('bottom')
<div class="modal fade" role="dialog" id="add-service-modal">
    <div class="modal-dialog" role="document">
        <form id="add-form" action="{{ route('admin.service.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
...
<div class="modal fade" role="dialog" id="edit-service-modal">
    <div class="modal-dialog" role="document">
        <form id="edit-form" action="{{ route('admin.service.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Ubah Service</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<script type="text/javascript">
    $(function() {
        ...
        $(document).on('click', '.edit-button', function() {
            ...
            $.ajax({
                method: "POST",
                url: "{{ route('admin.service.get_edit') }}",
                data: {
                    id: id
                },
            ...
            if (id.length > 0) {
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "DELETE",
                            url: "{{ route('admin.service.destroy_all') }}",
                            data: {
                                id: id
                            },
                            success: function(data) {
